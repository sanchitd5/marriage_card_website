...
// gallery veil, audio) are the shared techno modules, reached via
...
import { initKineticDecrypt } from './app/kinetic-decrypt.js';
...
class KineticApp {
  ...
  bootImmediate() {
    ...
    initFullscreenToggle();
    initCountdown();
    initKineticDecrypt(); // hold-to-decrypt cipher plate (replaces the foil scratch-off)
    initCalendarButtons();
    initScrollCue();
